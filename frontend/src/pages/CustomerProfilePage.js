      ...
      <main className="max-w-2xl mx-auto px-4 py-6 space-y-4">
          ...
          <CardContent className="space-y-3 px-4 pb-4">
            <div>
              ...
              <Input value={form.emergency_contact_name}
                onChange={e => setForm(f=>({...f,emergency_contact_name:e.target.value}))} className="mt-1" />
            </div>
            <div>
              <Label>Contact Phone</Label>
              <Input value={form.emergency_contact_phone}
                onChange={e => setForm(f=>({...f,emergency_contact_phone:e.target.value}))} className="mt-1" />
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent className="px-4 pb-4">
            ...
            <p className="text-xs text-muted-foreground mt-1">To change your email or password, contact K9 Country Club staff.</p>
          </CardContent>
        </Card>
      </main>
    </div>
